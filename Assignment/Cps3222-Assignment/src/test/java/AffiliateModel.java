...
/**
 * Affiliate Model used to complete task 3
 */
public class AffiliateModel implements FsmModel{
    private boolean bronze = false, silver = false, gold = false;
    private AdPlatform plat = new AdPlatform();//the default platform
    private Affiliate aff =  new Affiliate(1,"pass1","Client1");//the default affiliate
    ...
    public @Action void onClick50(){
        ...
        if(nextProb == 5 ){//if true withdraw state is triggered
        ...
        }else {//increment the contents of the balance by 50c
    ...
    //action
    //check if it should be promoted to silver or not
    ...
    //same as 50 but to the silver state
